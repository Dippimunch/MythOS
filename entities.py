...
class Person:
    ...
    def symbol(self, target):
        pass
        # apply concept to entity/event/etc

class Plant:
    def __init__(self, name, germ_rate):
        self.name = name
        self.germ_rate = germ_rate # how easy to grow?
        # time to harvest
        # yield
        self.growth = 0
...
class Language:
    def __init__(self, name, consonants, vowels, syll_struct, base, words, features={}):
        self.name = name
        # most of this needs to be moved to Features
        self.consonants = consonants
        self.vowels = vowels
        # NEED BETTER NAME SYLL_LIST VS SYLL_STRUCT
        self.syll_struct = ['CV']
        # append list of allowable combinations
        self.syll_struct.append(syll_struct)
